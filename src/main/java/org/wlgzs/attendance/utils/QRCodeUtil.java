...
public class QRCodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://zhangshunhai.xin/signin/to";
        //不含Logo
        //QRCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片名
        String qrcode = QRCodeUtil.encode(text, null, "D:\\Projects\\attendance\\src\\main\\resources\\static\\images", "qrcode", true);
